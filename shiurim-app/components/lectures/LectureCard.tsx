...
import { FlatLecture, Lecture, formatDuration, isR2Hosted, parseLectureDate } from '@/lib/lecture-utils'
          ...
          isR2Hosted(lecture.audioUrl) ? (
            ...
            <span
              ...
              className="opacity-0 group-hover:opacity-100 transition-opacity cursor-not-allowed
                         hidden sm:flex items-center gap-1 text-[10px] text-stone-300"
